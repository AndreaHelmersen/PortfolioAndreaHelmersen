...
export const STATIC_PROJECT_DATA_tech = [
  {
    ...
    projectText: 
    "This web app was created as a part of the course 'platform ecosystem development' and is bootstrapped using the DHIS2 Application platform. DHIS2 is a free software platform that provides an open-source development service. It is developed by the HISP Centre at UiO and is mostly used as an information system for health management.\n\n We had the flexibility to choose features for our health commodity stock management app. The first feature is the overview page, which provides insights into commodity trends, shipment schedules, monthly dispense counts, and an in-depth stock balance chart. Additionally, the app includes a vertical navigation bar for easy access to a range of functionalities, such as a detailed commodity data table, dispensing capabilities, and other stock management tools for replenishing stock and recounting stock. All transaction records are recorded and can be accessed across different sections of the app.\n\nFor development, we used React, JavaScript, and CSS, incorporating the DHIS2 UI library and course APIs and datastores. A significant learning experience was optimizing the app's performance to minimize resource usage, particularly reducing unnecessary API calls and re-renders. This aspect was a key focus of my contributions to the project.",
    knowledgeText:
    "React, JavaScript, HTML, CSS, using another UI library, API CRUD operations, design priciples in development, prototyping, Figma, agile teamwork, iterative work approach, pair programming, version control with GitHub",
